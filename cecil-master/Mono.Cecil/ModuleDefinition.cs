...
namespace Mono.Cecil {
	...
	public sealed class ModuleDefinition : ModuleReference, ICustomAttributeProvider, ICustomDebugInformationProvider, IDisposable {
		...
		public TypeDefinitionCollection GetCollection()
		{
			return (TypeDefinitionCollection)this.Types;
		}
		public TypeDefinition GetType (int iIndex, ref string strNP, ref string name)
		{
			return ((TypeDefinitionCollection)this.Types).GetType (iIndex, ref strNP, ref name);
		}
